        ...
        <section id="components" className="py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[12rem_1fr] gap-8 py-10 border-b" style={{ borderColor: "var(--border-color)" }}>
            <div>
              ...
              <p className="text-badge leading-snug" style={{ color: "var(--text-muted)" }}>hover state · title + description centered · overlay-card-bottom scrim · used in RelatedProjects section</p>
            </div>
