...
function SectionLabel({ number, title }: { number: string; title: string }) {
  return (
    <p className="text-badge uppercase tracking-label font-medium mb-3 text-[color:var(--text-muted)]">
      {number} / {title}
    </p>
  )
}
...
function SectionHeading({ children }: { children: React.ReactNode }) {
  return (
    <h2 className="text-h1 font-semibold leading-cta tracking-tight-25 mb-12 text-[color:var(--text-primary)]">
      {children}
    </h2>
  )
}
...
function Divider() {
  return <hr className="border-t my-0 border-[color:var(--border-color)]" />
}

function SpecLabel({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-badge font-mono mt-2 text-[color:var(--text-muted)]">
      {children}
    </p>
  )
}
  ...
  return (
    <div
      className={[
        ...
        dark ? "border-[color:var(--dark-border)]" : "border-[color:var(--border-color)]",
      ].join(" ")}
    >
      {/* The backgroundColor must be inline — it references a dynamic CSS variable name */}
      <div
        className={`h-20 ${addBorder ? "border-b border-[color:var(--border-color)]" : ""}`}
        style={{ backgroundColor: `var(${varName})` }}
      />
      <div className={`p-3 ${dark ? "bg-[color:var(--dark-surface)]" : "bg-[color:var(--surface)]"}`}>
        <p className={`text-badge font-mono font-medium ${dark ? "text-[color:var(--dark-text-primary)]" : "text-[color:var(--text-primary)]"}`}>
          {varName}
        </p>
        <p className={`text-badge font-mono mt-0.5 ${dark ? "text-[color:var(--dark-text-muted)]" : "text-[color:var(--text-muted)]"}`}>
          {hex}
        </p>
        <p className={`text-badge mt-1 leading-snug ${dark ? "text-[color:var(--dark-text-muted)]" : "text-[color:var(--text-muted)]"}`}>
          {usage}
        </p>
      </div>
    </div>
...
function TypeSpecimen({
  ...
  sample: string; spec: string; cls?: string
}) {
  return (
    <div className="py-8 border-b border-[color:var(--border-color)]">
      <p className={`text-[color:var(--text-primary)] ${cls ?? "text-base"}`}>
        {sample}
      </p>
...
function RadiusSwatch({ label, px }: { label: string; px: number }) {
  ...
  return (
    <div className="flex flex-col gap-2 items-start">
      {/* width/height/borderRadius are dynamic — must stay inline */}
      <div
        style={{ width: isFull ? 96 : 64, height: 64, borderRadius: px }}
        className="bg-[color:var(--surface)] border border-[color:var(--border-color)]"
      />
      <p className="text-badge text-[color:var(--text-primary)]">{label}</p>
      <p className="text-badge font-mono text-[color:var(--text-muted)]">{isFull ? "full" : `${px}px`}</p>
    </div>
  )
}
...
function SpacingSwatch({ step, px }: { step: string; px: number }) {
  return (
    <div className="flex flex-col gap-2 items-start">
      ...
      <div
        style={{ width: Math.max(px, 4), height: 32, borderRadius: 4 }}
        className="bg-[color:var(--surface)] border border-[color:var(--border-color)]"
      />
      <p className="text-badge font-mono text-[color:var(--text-primary)]">{step}</p>
      <p className="text-badge font-mono text-[color:var(--text-muted)]">{px}px</p>
    </div>
  )
}
...
function EffectChip({
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* chipStyle applies dynamic effects (blur, shadow) — must stay inline */}
      <div
        className="w-20 h-20 rounded-xl bg-[color:var(--surface)] border border-[color:var(--border-color)]"
        style={chipStyle}
      />
      <div>
        <p className="text-badge font-medium text-[color:var(--text-primary)]">{label}</p>
        {tokenName && (
          <p className="text-badge font-mono mt-0.5 text-[color:var(--accent)]">{tokenName}</p>
        )}
        <p className="text-badge font-mono mt-0.5 text-[color:var(--text-muted)]">{note}</p>
      </div>
    </div>
  )
}
...
export default function StyleguidePage() {
  return (
    <div className="bg-[color:var(--bg)] text-[color:var(--text-primary)]">
      ...
      {/* ── Header ─────────────────────────────────────────────── */}
      <header className="px-8 pt-16 pb-20 bg-[color:var(--dark-bg)]">
        <div className="max-w-[var(--max-width-page)] mx-auto">
          <p className="text-badge uppercase tracking-label font-medium mb-4 text-[color:var(--dark-text-muted)]">
            internal / reference
          </p>
          <h1 className="text-hero-sm md:text-hero-lg font-semibold leading-hero tracking-tight-3 mb-4 text-[color:var(--dark-text-primary)]">
            Styleguide
          </h1>
          <p className="text-base leading-body text-[color:var(--dark-text-secondary)]">
      ...
      {/* ── Section pill nav ───────────────────────────────────── */}
      <div className="sticky top-0 z-40 border-b overflow-x-auto bg-[color:var(--navbar-bg-scroll-light)] [backdrop-filter:blur(var(--blur-navbar))] border-[color:var(--border-color)]">
      ...
      <div className="max-w-[var(--max-width-page)] mx-auto px-6 md:px-8">
        ...
        <section id="colors" className="py-20">
          ...
          {/* Light context */}
          <p className="text-badge uppercase tracking-label font-medium mb-4 text-[color:var(--text-muted)]">
          ...
          <div className="rounded-2xl p-6 mb-12 bg-[color:var(--dark-bg)] border border-[color:var(--dark-border)]">
        ...
        <section id="typography" className="py-20">
          ...
          />
          <div className="py-8">
            <p className="font-mono text-badge text-[color:var(--text-primary)]">
              carlos.psd / EN · PT
            </p>
        ...
        <section id="spacing" className="py-20">
          ...
          {/* Scale */}
          <p className="text-badge uppercase tracking-label font-medium mb-6 text-[color:var(--text-muted)]">
            Scale
          </p>
          ...
          <div className="flex flex-col gap-0 mb-16 border-t border-[color:var(--border-color)]">
            {[
              ...
              <div key={token} className="grid grid-cols-[10rem_1fr_1fr] gap-6 py-4 border-b border-[color:var(--border-color)] items-baseline">
                ...
                <span className="text-badge font-mono font-medium text-[color:var(--text-primary)]">{value}</span>
                <span className="text-badge opacity-60 text-[color:var(--text-muted)]">{note}</span>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col gap-0 border-t border-[color:var(--border-color)]">
            {[
              ...
              <div key={token} className="grid grid-cols-[10rem_1fr_1fr] gap-6 py-4 border-b border-[color:var(--border-color)] items-center">
                <span className="text-badge font-mono text-[color:var(--text-muted)]">{token}</span>
                <span className="text-badge font-mono font-medium text-[color:var(--text-primary)]">{value}</span>
                <span className="text-badge opacity-60 text-[color:var(--text-muted)]">{note}</span>
              </div>
        ...
        <section id="components" className="py-20">
          ...
          {/* CTA Button */}
          <div className="grid grid-cols-1 md:grid-cols-[12rem_1fr] gap-8 py-10 border-b border-[color:var(--border-color)]">
            <div>
              <p className="text-badge font-medium mb-1 text-[color:var(--text-primary)]">CTA Button</p>
              <p className="text-badge leading-snug text-[color:var(--text-muted)]">pill · hover:opacity-80 · used in Navbar and Contact</p>
            </div>
            <div className="flex flex-wrap gap-4 items-center">
              <button className="text-badge font-medium px-5 py-2 rounded-full transition-all duration-200 hover:opacity-80 bg-[color:var(--text-primary)] text-[color:var(--bg)]">
                Get in touch
              </button>
              <p className="text-badge font-mono text-[color:var(--text-muted)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[12rem_1fr] gap-8 py-10 border-b border-[color:var(--border-color)]">
            <div>
              <p className="text-badge font-medium mb-1 text-[color:var(--text-primary)]">Text links</p>
              <p className="text-badge leading-snug text-[color:var(--text-muted)]">underline via border-b · hover:accent on light bg · hover:accent-on-dark on dark bg</p>
            </div>
            <div className="flex flex-col gap-4">
              <div className="flex flex-wrap gap-8 items-center">
                ...
                <p className="text-badge font-mono text-[color:var(--text-muted)]">light bg</p>
              </div>
              <div className="flex flex-wrap gap-8 items-center px-5 py-4 rounded-xl bg-[color:var(--dark-bg)] border border-[color:var(--dark-border)]">
                ...
                <p className="text-badge font-mono ml-auto text-[color:var(--dark-border)]">dark bg</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[12rem_1fr] gap-8 py-10 border-b border-[color:var(--border-color)]">
            <div>
              <p className="text-badge font-medium mb-1 text-[color:var(--text-primary)]">Badge</p>
              <p className="text-badge leading-snug text-[color:var(--text-muted)]">outline variant · always on dark backgrounds · project card overlay</p>
            </div>
            <div className="flex flex-wrap gap-3 items-center px-5 py-4 rounded-xl bg-[color:var(--dark-bg)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[12rem_1fr] gap-8 py-10 border-b border-[color:var(--border-color)]">
            <div>
              <p className="text-badge font-medium mb-1 text-[color:var(--text-primary)]">Navbar</p>
              <p className="text-badge leading-snug text-[color:var(--text-muted)]">sticky · blur(--blur-navbar) · adapts bg on scroll</p>
            </div>
            <div className="flex items-center justify-between px-6 h-14 rounded-xl overflow-hidden bg-[color:var(--navbar-bg)] border border-[color:var(--border-color)] [backdrop-filter:blur(var(--blur-navbar))]">
              <span className="font-mono text-badge font-medium text-[color:var(--text-primary)]">carlos.psd</span>
              <div className="flex items-center gap-1">
                <span className="text-badge font-medium px-3 py-1.5 rounded-full text-[color:var(--text-muted)]">Work</span>
                <span className="text-badge font-medium px-3 py-1.5 rounded-full bg-black/[0.06] text-[color:var(--text-primary)]">About</span>
                <span className="text-badge font-medium px-3 py-1.5 rounded-full text-[color:var(--text-muted)]">Contact</span>
              </div>
              <div className="flex items-center gap-3">
                ...
                <span className="text-badge font-medium px-4 py-1.5 rounded-full bg-[color:var(--text-primary)] text-[color:var(--bg)]">Get in touch</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[12rem_1fr] gap-8 py-10 border-b border-[color:var(--border-color)]">
            <div>
              <p className="text-badge font-medium mb-1 text-[color:var(--text-primary)]">Project Card</p>
              <p className="text-badge leading-snug text-[color:var(--text-muted)]">aspect-card 4/3 · gradient-card-overlay scrim · used in FeaturedWork</p>
            </div>
            <div className="w-56">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[12rem_1fr] gap-8 py-10 border-b border-[color:var(--border-color)]">
            <div>
              <p className="text-badge font-medium mb-1 text-[color:var(--text-primary)]">Related Projects Card</p>
              <p className="text-badge leading-snug text-[color:var(--text-muted)]">hover state · title + description centered · overlay-card-bottom scrim · used in RelatedProjects section</p>
            </div>
                ...
                <div key={p.slug} className="block group">
                  <div className="relative w-full overflow-hidden aspect-card rounded-xl bg-[color:var(--dark-surface)]">
                    ...
                    <div className="absolute inset-0 transition-opacity duration-300 opacity-0 group-hover:opacity-100">
                      ...
                      <div className="absolute inset-0 bg-[color:var(--overlay-card-bottom)]" />
                    </div>
                    <div className="absolute inset-0 flex flex-col items-center justify-end p-6 gap-2 transition-all duration-300 translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100">
                      <p className="font-semibold text-lg leading-snug tracking-tight-2 text-center text-[color:var(--dark-text-primary)]">{p.title}</p>
                      <p className="text-badge leading-snug line-clamp-2 text-center text-[color:var(--dark-text-secondary)]">{p.description}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          {/* Lightbox */}
          <div className="grid grid-cols-1 md:grid-cols-[12rem_1fr] gap-8 py-10">
            <div>
              <p className="text-badge font-medium mb-1 text-[color:var(--text-primary)]">Lightbox</p>
              <p className="text-badge leading-snug text-[color:var(--text-muted)]">modal · overlay-backdrop · blur-lightbox · case study galleries</p>
            </div>
            <div className="relative rounded-xl overflow-hidden h-56 flex items-center justify-center bg-[color:var(--overlay-backdrop)]">
              <div className="w-3/5 h-36 rounded-lg flex items-center justify-center bg-[color:var(--dark-surface)] border border-[color:var(--dark-border)]">
                <span className="text-badge font-mono text-center text-[color:var(--dark-text-muted)]">
                  image<br />max-w-lightbox · max-h-lightbox
                </span>
              </div>
              <button className="absolute top-3 right-3 w-8 h-8 rounded-full flex items-center justify-center text-badge bg-[color:var(--dark-surface)] text-[color:var(--dark-text-primary)] border border-[color:var(--dark-border)]">
                ✕
              </button>
              <div className="absolute bottom-3 left-4">
                <span className="text-badge font-mono text-[color:var(--dark-border)]">
        ...
        <section id="effects" className="py-20">
          ...
          <div className="flex flex-col gap-4 mb-16">
            <div className="rounded-xl overflow-hidden h-16 bg-[color:var(--dark-bg)] [background-image:var(--gradient-hero-fade)]" />
            <SpecLabel>--gradient-hero-fade — linear-gradient(to bottom, transparent, var(--dark-bg))</SpecLabel>
            <div className="rounded-xl overflow-hidden h-16 mt-4 [background-image:var(--gradient-card-overlay)]" />
          ...
          <div className="flex flex-col gap-0 border-t border-[color:var(--border-color)]">
            {[
              ...
              <div key={label} className="grid grid-cols-[10rem_1fr] gap-6 py-4 border-b border-[color:var(--border-color)] items-baseline">
                <span className="text-badge font-mono text-[color:var(--text-muted)]">{label}</span>
                <span className="text-badge font-mono font-medium text-[color:var(--text-primary)]">{value}</span>
              </div>
            ))}
          </div>
      ...
      {/* ── Footer ─────────────────────────────────────────────── */}
      <footer className="border-t border-[color:var(--border-color)] px-8 py-8 flex items-center justify-between">
        <span className="font-mono text-badge text-[color:var(--text-muted)]">carlos.psd / styleguide</span>
        <span className="text-badge text-[color:var(--text-muted)]">internal reference</span>
      </footer>
